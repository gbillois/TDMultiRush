# Boutique - Convention de fichiers
...
- Le modele de base reste les fichiers existants (non boutique):
  - `tower-arcane`, `castle-right`, `projectile-arcane`
- Les fichiers `02` a `05` sont actuellement des placeholders: remplace-les par tes vrais graphismes.
- Garde le format PNG et les memes noms pour que la boutique les charge sans modification de code.
